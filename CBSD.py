...
class CBSD(object):
    def __init__(self):
        ...
        self.sas_url_base = 'https://10.147.20.191:1443/sas-api/' # enter your SAS URL
        #self.sas_url_base = 'https://test.sas.goog/v1.2/' # enter your SAS URL
        self.header = {"content-type" : "application/json",}
        self.cert_file_path = 'Certs/client_10.147.20.143-0.crt' # point to your vendor certificate
        self.key_file_path = 'Certs/client_10.147.20.143-0.key' # point to your vendor certificate
